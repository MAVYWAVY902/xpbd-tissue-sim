...
class MeshSDFGPUResource : public HostReadableGPUResource
{
    ...
    virtual void allocate() override
    {
        ...
        CHECK_CUDA_ERROR(cudaMalloc3D(&_d_dist_grid, dist_grid_extent));
    }
    ...
    virtual void copyToDevice() const override
    {
        ...
        dist_copy_params.dstPtr = _d_dist_grid;
    ...
    cudaPitchedPtr devDistGrid() const { return _d_dist_grid; }

    private:
    const Geometry::MeshSDF* _sdf;
    cudaPitchedPtr _d_dist_grid;
