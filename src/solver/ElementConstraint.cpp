...
ElementConstraint::ElementConstraint(const double dt, XPBDMeshObject* obj, unsigned v1, unsigned v2, unsigned v3, unsigned v4)
    : Constraint(dt)
{
...
Eigen::Matrix3d ElementConstraint::_computeF() const
{
    Eigen::Matrix3d X;
    const Eigen::Vector3d X3 = _positions[3].position();
