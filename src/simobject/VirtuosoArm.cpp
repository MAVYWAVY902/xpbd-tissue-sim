...
void VirtuosoArm::setActuatorValues(Real ot_rotation, Real ot_translation, Real it_rotation, Real it_translation)
{
...
Mat3r VirtuosoArm::_3DOFAnalyticalHybridJacobian()
{
    ...
    Eigen::Matrix<Real,6,3> J_b = innerTubeEndFrame().transform().inverse().adjoint() * _3DOFSpatialJacobian();
    // std::cout << "J_b:\n" << J_b << std::endl;
    Mat3r J_a = C * R * J_b;
